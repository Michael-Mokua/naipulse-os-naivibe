  ...
  return (
    <header className="topbar" role="banner">
      ...
      <nav className="nav-tabs" role="navigation" aria-label="Module navigation">
        ...
        <Link to="/feed" className="nav-tab">
          <i className="ti ti-rss" />
          FEED
        </Link>
        
        <Link to="/chat" className="nav-tab chat-primary">
          <i className="ti ti-message" />
          CHAT
        </Link>
        
        <Link to="/safe-routes" className="nav-tab">
          <i className="ti ti-route" />
          ROUTES
        </Link>
        
        <Link to="/community-watch" className="nav-tab">
        ...
        <Link to="/lost-found" className="nav-tab">
          <i className="ti ti-search" />
          LOST
        </Link>
        
        <Link to="/carpool" className="nav-tab">
      ...
      <div className="topbar-auth-links">
        {isAuthenticated ? (
          <>
            <span className="topbar-user-info">{user?.user_metadata?.full_name || user?.email || 'Mwananchi'}</span>
            <button type="button" className="topbar-auth-link logout" onClick={logout}>LOG OUT</button>
          </>
        ) : (
          <>
            <Link to="/login" className="topbar-auth-link login">LOG IN</Link>
            <Link to="/signup" className="topbar-auth-link signup">SIGN UP</Link>
          </>
        )}
      </div>
